...
namespace FinalProjectThatWorks.UI.MVC.Controllers
{
    public class CarsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "OwnerAssetId,CarName,OwnerId,CarPhoto,SpecialNotes,IsActive,DateAdded")] Car car)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OwnerAssetId,CarName,OwnerId,CarPhoto,SpecialNotes,IsActive,DateAdded")] Car car)
        {
            if (ModelState.IsValid)
            {
